    ...
    public class AgeTests 
    {
        ...
        public void Bug_Trap_0_hour_bug()
        {
            ...
            while (timespan <= TimeSpan.FromHours(3))
            {
                ...
                {
                    throw new Exception(String.Format("{0} ticks breaks this mofo!", timespan.Ticks));
                }
        ...
        public void Age_1_21second()
        {
            ...
            Assert.Equal("1 microfortnight", result);
        ...
        public void Age_1_5years()
        {
            ...
            Assert.Equal(String.Format("{0} years", 1.5), result);
        }
        ...
        public void Age_52Day()
        {
            ...
            Assert.Equal("1 dog year", result);
        }
        ...
        public void Age_52minutes()
        {
            ...
            Assert.Equal("1 microcentury", result);
        }
        ...
        public void Age_90minutes()
        {
            ...
            Assert.Equal(String.Format("{0} hours", 1.5), result);
        }
